# -*- coding: utf-8 -*-
"""
Django settings for Appagoo project.
...
class Common(Configuration):
    ...
    ADMINS = (
        ("""Alessio De Santo""", 'alessio.desanto@he-arc.ch'),
    )
    ...
    DATABASES = values.DatabaseURLValue('postgres://appagoo:appagoo@localhost/appagoo')
